...
KAFKA_TOPIC = os.getenv('CKN_KAFKA_TOPIC', 'oracle_events')
...
if __name__ == "__main__":
    ...
    if not os.path.exists(ORACLE_EVENTS_FILE):
        print(f"File {ORACLE_EVENTS_FILE} does not exist. Creating it.")
    ...
    print(f"Watching file: {ORACLE_EVENTS_FILE}")
    observer.start()
