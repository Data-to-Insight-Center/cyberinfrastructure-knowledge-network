...
public class RawAlerter {
    ...
    public static void main(String[] args) {
        ...
        try (InputStream input = RawAlerter.class.getClassLoader().getResourceAsStream("config.properties")) {
    ...
    private static StreamsBuilder buildAlertEventStream() {
        ...
        inferenceEventKStream
                .filter((key, value) -> value.getPred_accuracy() < 0.4)
