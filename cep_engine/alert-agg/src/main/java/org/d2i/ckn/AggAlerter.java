...
public class AggAlerter {
    ...
    public static void main(String[] args) {
        ...
        try (InputStream input = AggAlerter.class.getClassLoader().getResourceAsStream("config.properties")) {
    ...
    private static StreamsBuilder buildAlertEventStream() {
        ...
        inferenceEventKStream
                ...
                .mapValues(value -> {
                    ...
                    String formattedDate = dateFormat.format(new Date(System.currentTimeMillis())); // Convert current time millis to formatted string
